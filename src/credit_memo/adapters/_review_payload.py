...
borrower identifier reaches human-review-console over the wire; human-review-console redacts
again before its own audit write (defense in depth). The maker (the officer/assistant that
originated the memo) and the tenant are asserted here and trusted by human-review-console
