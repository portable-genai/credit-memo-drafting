...
binds to the human-review-console submission adapter; switching ``profile`` to ``onprem``
rebinds it here. The adapter constructs cleanly with **no external dependencies** and
structurally satisfies the same
...
never let a consequential memo bypass human review (P-06, rule R8), so porting on-premise *must*
