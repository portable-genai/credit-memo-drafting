...
intake (``POST /v1/service/reviews``), S2S-authenticated. The human-review-console base URL
comes from the environment (``HUMAN_REVIEW_URL``) and the S2S credentials from this repo's
shared env-var names
