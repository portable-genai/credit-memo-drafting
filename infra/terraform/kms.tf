...
#         resource hands to another service. Each managed service (Storage, Agent Runtime,
#         Logging, Secret Manager) is told to use this key explicitly. We keep ONE regional
