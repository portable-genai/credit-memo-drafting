"""R8 routing: an escalated credit memo is routed to human-review-console via the shared
review-kit.

Every credit memo requires human review (P-06), so rule R8 says it MUST be handed to the
human-review-console maker-checker console rather than left as a boolean. These tests prove
the producer half of that
