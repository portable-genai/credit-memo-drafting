...
Runs fully offline: the model-quality-gate endpoint is mocked with respx and never actually
served. The localhost default below MUST match ``QUALITY_GATE_URL``'s default in the adapter.
"""
