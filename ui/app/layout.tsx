...
export default function RootLayout({
  ...
  // The model pills render in BOTH modes, and embedded is the mode that needs them most: a panel
  // inside somebody else's portal is where a viewer has least context about which model
  // answered. They are mounted in the LAYOUT rather than in a page because "on every page" is a
  // property of the console, and a page that forgot them would be the one page a screenshot
  // came from.
  return (
    <html lang="en">
