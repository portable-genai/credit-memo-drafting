...
def build_spec() -> PluginSpec:
    ...
    from credit_memo.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/credit-memo-drafting",
        ...
        servers={
            "credit-memo-drafting": StdioServer(
                command="python",
                args=("-m", "credit_memo.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
