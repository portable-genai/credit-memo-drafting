"""Portability tour: prove credit-memo-drafting's no-lock-in claims live, on a laptop, fully offline.
...
Scope note (honest about what this repo does and does not implement): credit-memo-drafting's ``local``
